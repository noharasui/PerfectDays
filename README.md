...
Used to store diary entries. Images are stored on the user’s device or in cloud backup services configured by the user, such as Google Drive, Dropbox, iCloud, or OneDrive. They are not uploaded to the app’s own servers.

#### 2. Location Data

Used only when the user manually adds location information to a diary entry. Location data is stored on the user’s device or in cloud backup services configured by the user, and is not uploaded to the app’s own servers.
...
#### 4. Diary Text and Related Content

Diary text and other user-added content are stored on the user’s device or in cloud backup services configured by the user, and are not uploaded to the app’s own servers.

#### 5. Analytics & Crash Data (Firebase Analytics / Firebase Crashlytics)
...
* Supporting user-configured cloud backup features
...
* User content, including diary text, images, location data, and health-related data, is stored locally on the user’s device by default.
* If the user enables backup, data may also be stored in cloud services selected and configured by the user, including Google Drive, Dropbox, iCloud, or OneDrive.
...
* Withdraw permissions (such as location or health data access)
